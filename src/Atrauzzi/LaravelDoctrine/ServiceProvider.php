...
class ServiceProvider extends Base {
	...
	public function register() {
		...
		// Commands
		//
		if(str_contains(getcwd(), "/ptx/public")){
			...
			@AnnotationRegistry::registerFile(
				...
				@AnnotationRegistry::registerFile(
                				"../vendor/symfony/validator/Symfony/Component/Validator/Constraints/Count.php");

                			@AnnotationRegistry::registerFile(
                				"../vendor/symfony/validator/Symfony/Component/Validator/Constraints/NotBlank.php");
                			@AnnotationRegistry::registerFile(
                				"../vendor/symfony/validator/Symfony/Component/Validator/Constraints/Range.php");
